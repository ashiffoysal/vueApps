            ...
            <div class="swiper-wrapper">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                      <img
                        src="public/backendadmin/assets/img/illustrations/card-website-analytics-1.png"
              ...
              <div class="swiper-slide">
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                    <img
                      src="public/backendadmin/assets/img/illustrations/card-website-analytics-2.png"
                      alt="Website Analytics"
                      width="170"
                      class="card-website-analytics-img"
                    />
              ...
              <div class="swiper-slide">
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                    <img
                      src="public/backendadmin/assets/img/illustrations/card-website-analytics-3.png"
                      alt="Website Analytics"
                      width="170"
                      class="card-website-analytics-img"
                    />
            ...
            <div class="card-body">
              <ul class="p-0 m-0">
                <li class="d-flex align-items-center mb-4">
                  <img src="public/backendadmin/assets/svg/flags/us.svg" alt="User" class="rounded-circle me-3" width="34" />
                ...
                <li class="d-flex align-items-center mb-4">
                  <img src="public/backendadmin/assets/svg/flags/br.svg" alt="User" class="rounded-circle me-3" width="34" />
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      <div class="d-flex align-items-center">
                ...
                <li class="d-flex align-items-center mb-4">
                  <img src="public/backendadmin/assets/svg/flags/in.svg" alt="User" class="rounded-circle me-3" width="34" />
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      <div class="d-flex align-items-center">
                ...
                <li class="d-flex align-items-center mb-4">
                  <img src="public/backendadmin/assets/svg/flags/au.svg" alt="User" class="rounded-circle me-3" width="34" />
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      <div class="d-flex align-items-center">
                ...
                <li class="d-flex align-items-center mb-4">
                  <img src="public/backendadmin/assets/svg/flags/fr.svg" alt="User" class="rounded-circle me-3" width="34" />
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      <div class="d-flex align-items-center">
                ...
                <li class="d-flex align-items-center">
                  <img src="public/backendadmin/assets/svg/flags/cn.svg" alt="User" class="rounded-circle me-3" width="34" />
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      <div class="d-flex align-items-center">
